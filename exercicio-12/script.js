...
addTechBtn.addEventListener('click', function(ev) {
    ...
    removeRowBtn.addEventListener('click', () => stackInputs.removeChild(newRow))


    newRow.append(techNameLabel, techNameInput, expLabel, exRadio1, expLabel1, exRadio2, expLabel2, exRadio3, expLabel3, removeRowBtn)
